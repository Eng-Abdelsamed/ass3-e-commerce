            ...
            <div className="bg-white p-8 lg:p-12 rounded-[2.5rem] shadow-2xl shadow-gray-200/50 border border-gray-100 w-full max-w-lg mx-auto transform transition-all">
                ...
                <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="group">
                        ...
                        <div className="password-strength pt-3">
                            <div className="bar flex gap-1.5 h-1.5 mb-2">
                                <div className="flex-1 bg-red-500 rounded-full shadow-sm shadow-red-200"></div>
                            ...
                            <div className="flex justify-between items-center px-1">
                                ...
                                <span className="text-[10px] font-black text-red-500 uppercase tracking-widest">weak</span>
                            </div>
                        </div>
                    </div>
                    <div className="group">
