              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className=" flex flex-col sm:flex-row gap-3 mb-6">
                  <button
                    ...
                    className={`flex-1 text-white py-3.5 px-6 rounded-xl font-medium active:scale-[0.98] transition duration-200 ${
                      isInCart
                ...
                <div className=" flex gap-3 mb-6">
                  <button
                    ...
                    className={`flex-1 border-2 py-3 px-4 rounded-xl font-medium flex items-center justify-center gap-2 transition-all duration-300 ${
                      isInWishlist
            ...
            <div className="flex border-b border-gray-100 overflow-x-auto">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`flex items-center gap-2 px-8 py-5 text-sm font-semibold transition duration-200 whitespace-nowrap ${
                    activeTab === tab.id
