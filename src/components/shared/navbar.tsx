...
export default function Navbar({ categories }: { categories: Category[] }) {
  ...
  return (
    <>
      <header className="bg-white ">
        <div className="w-full mx-auto px-6 lg:px-10 ">
          ...
          <nav className="flex items-center justify-between py-4 gap-4 lg:gap-8">
            ...
            <section className="flex-1 max-w-xl relative hidden lg:flex">
              <input
                type="text"
                className="w-full py-2.5 px-4 pr-12 border border-gray-300 rounded-full text-sm focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all duration-200"
            ...
            <ul className="flex items-center gap-4 lg:gap-6">
              ...
              <li>
                ...
                >
                  ...
                  <span className="  absolute -top-2  -translate-y-1/2 size-4.5 rounded-full bg-primary-600 text-white text-xs flex items-center justify-center ">
                    {numOfCartItems}
                  </span>
        ...
        <nav className="bg-gray-200 block border-t border-gray-100">
          <div className="w-full mx-auto px-6 lg:px-10 flex items-center gap-8 ">
            ...
            <div ref={dropdownRef} className="relative">
              ...
              {/* Dropdown Menu */}
              <div
                className={`absolute top-full left-0 mt-2 bg-white shadow-lg rounded-lg w-64 py-2 z-50 transition-all duration-200 transform origin-top ${
                  isOpen
                ...
                <ul className="max-h-[70vh] overflow-y-auto custom-scrollbar">
                  ...
                  <li className="border-t border-dashed border-gray-200 mt-2 pt-2">
                    <Link
                      href="/categories"
                      onClick={() => setIsOpen(false)}
                      className="flex items-center justify-center gap-3 px-4 py-3 text-emerald-600 font-bold hover:bg-green-50 transition-colors duration-200"
                    >
      ...
      {/* Sidebar Menu */}
      <aside
        className={`fixed inset-y-0 left-0 w-80 max-w-[85vw] bg-white z-100 lg:hidden transform transition-transform duration-300 ease-in-out shadow-2xl flex flex-col ${
